...
Bu doküman, iş ihtiyacından başlayarak API gereksinimlerine ve kabul kriterlerine kadar olan analiz sürecini kapsamaktadır.

Doküman sırası aşağıdaki gibidir.
...
- [Stakeholder Interview](Stakeholder-Interview-01.md)
...
Bu kabul kriterleri doğrultusunda oluşturulacak test senaryoları ayrı bir dokümanda takip edilecektir.

- [Test Senaryoları](../testing/01-Test-Scenarios.md)
